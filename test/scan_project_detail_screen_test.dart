...
void main() {
  ...
  testWidgets(
    'ScanProjectDetailScreen displays project name, pages, and CamScanner buttons',
    (WidgetTester tester) async {
      ...
      expect(
        find.byKey(const ValueKey('target_pdf_size_chip')),
        findsOneWidget,
      );
      ...
      expect(
        find.byKey(const ValueKey('grid_view_smooth_grid')),
        findsOneWidget,
      );
      ...
      await tester.pumpAndSettle();
      expect(
        find.byKey(const ValueKey('list_view_smooth_grid')),
        findsOneWidget,
      );
    },
  );
  ...
  testWidgets(
    'Metadata banner does not overflow RenderFlex on narrow mobile screens (360px and 320px)',
    (WidgetTester tester) async {
      final project = ScanProject(
  ...
  testWidgets(
    'ScanPagePreviewScreen adapts properly to light theme and dark theme',
    (WidgetTester tester) async {
      final project = ScanProject(
  ...
  testWidgets(
    'ScanPagePreviewScreen renders tablet floating dock and navigation chevrons on tablets',
    (WidgetTester tester) async {
      final project = ScanProject(
        id: 'tablet_project',
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [authServiceProvider.overrideWithValue(MockAuthService())],
          child: MaterialApp(home: ScanPagePreviewScreen(project: project)),
        ),
      );
      await tester.pumpAndSettle();
  ...
  testWidgets(
    'ScanProjectDetailScreen supports multi-selection and CamScanner-style group drag',
    (WidgetTester tester) async {
      final project = ScanProject(
  ...
  testWidgets(
    'ScanProjectDetailScreen holding a page enters multi-select mode directly',
    (WidgetTester tester) async {
      final project = ScanProject(
  ...
  testWidgets(
    'dragging unselected page resets previous selection and selects only dragged page',
    (WidgetTester tester) async {
      final project = ScanProject(
  ...
  testWidgets(
    'List View supports CamScanner-style multi-select group drag and drop',
    (WidgetTester tester) async {
      final project = ScanProject(
      ...
      final dragGesture = await tester.startGesture(
        tester.getCenter(find.text('2/3')),
      );
      await tester.pump(const Duration(milliseconds: 600));

      // Multiple placeholders gaps should exist
      expect(
        find.byKey(const ValueKey('grid_placeholder_gap')),
        findsOneWidget,
      );
      expect(
        find.byKey(const ValueKey('grid_placeholder_gap_1')),
        findsOneWidget,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        find.byTooltip('Delete Selected'),
        findsOneWidget,
      ); // In bottom bar
  ...
  testWidgets(
    'ScanProjectDetailScreen has Print Document in more menu and ScanPagePreviewScreen has Print Page button',
    (WidgetTester tester) async {
      final project = ScanProject(
