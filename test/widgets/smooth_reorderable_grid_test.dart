...
void main() {
  ...
  testWidgets('SmoothReorderableGrid renders items and handles tap', (
    tester,
  ) async {
    int? tappedIndex;
  ...
  testWidgets(
    'SmoothReorderableGrid long-press lifts item and creates placeholder gap',
    (tester) async {
  ...
  testWidgets(
    'SmoothReorderableGrid drag-and-drop fires onReorder callback with correct indices',
    (tester) async {
      int? reorderOld;
      int? reorderNew;
  ...
  testWidgets(
    'SmoothReorderableGrid multi-select group drag creates multiple placeholder gaps and shows badge',
    (tester) async {
      final items = ['Page 1', 'Page 2', 'Page 3', 'Page 4'];
      ...
      final gesture = await tester.startGesture(
        tester.getCenter(find.text('Page 2')),
      );
      await tester.pump(const Duration(milliseconds: 600));
  ...
  testWidgets(
    'SmoothReorderableGrid multi-select group drop fires onGroupReorder preserving internal order',
    (tester) async {
