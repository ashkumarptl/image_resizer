...
void main() {
  ...
  setUpAll(() {
    ...
    standardJpgBytes = Uint8List.fromList(
      img.encodeJpg(standardImg, quality: 85),
    );
    ...
    ultraLargeJpgBytes = Uint8List.fromList(
      img.encodeJpg(largeImg, quality: 75),
    );
  });
  ...
  group('SafeImageDecoder Tests', () {
    ...
    test(
      'decodeSafe preserves exact dimensions for standard resolution images',
      () async {
    ...
    test(
      'decodeSafe downsamples ultra-large images when exceeding maxDimension',
      () async {
    ...
    test(
      'ensureSafeForMlKit downsizes ultra-large file to safe resolution',
      () async {
