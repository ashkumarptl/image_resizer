...
void main() {
  ...
  testWidgets(
    'CelebratorySavingsBanner displays reduction percentage and size transition',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: CelebratorySavingsBanner(result: result)),
        ),
      );
  ...
  testWidgets(
    'CelebratorySavingsBanner shows informational note when size not reduced',
    (WidgetTester tester) async {
      const result = ProcessResult(
      ...
      expect(
        find.textContaining('Dimensions matched exact portal specs'),
        findsOneWidget,
      );
    },
  );
