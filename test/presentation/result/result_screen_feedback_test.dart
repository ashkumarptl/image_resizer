...
void main() {
  ...
  testWidgets(
    'ResultScreen displays celebratory banner, print button, and next action suggestions',
    (WidgetTester tester) async {
      ...
      final tempDir = Directory.systemTemp.createTempSync(
        'result_feedback_test_',
      );
      final origFile = File('${tempDir.path}/orig.jpg')
      ...
      expect(methodCalls.any((call) => call.method == 'printImage'), isTrue);
