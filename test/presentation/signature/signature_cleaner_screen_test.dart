...
void main() {
  ...
  testWidgets('SignatureCleanerScreen renders threshold slider and handles maximum drag without assertion error',
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: SignatureCleanerScreen(initialImage: dummyImage),
      ),
    );
    await tester.pump();
