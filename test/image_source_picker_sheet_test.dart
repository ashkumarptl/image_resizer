...
void main() {
  ...
  testWidgets('ImageSourcePickerSheet.show renders bottom sheet with ML Kit and Gallery options',
      (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('ImageSourcePickerSheet.showMulti renders batch bottom sheet with ML Kit and Gallery options',
      (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
