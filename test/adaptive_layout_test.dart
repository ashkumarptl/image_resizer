...
void main() {
  group('AdaptiveLayoutExtension Tests', () {
    testWidgets('calculates WindowSizeClass.compact for widths < 600', (
      tester,
    ) async {
    ...
    testWidgets('calculates WindowSizeClass.medium for 600 <= width < 840', (
      tester,
    ) async {
    ...
    testWidgets('calculates WindowSizeClass.expanded for 840 <= width < 1200', (
      tester,
    ) async {
    ...
    testWidgets('responsiveValue selects correct value based on size class', (
      tester,
    ) async {
  ...
  group('AdaptiveSupportingPane Tests', () {
    testWidgets('renders single column scrollable on compact screens', (
      tester,
    ) async {
      tester.view.physicalSize = const Size(400, 800);
      tester.view.devicePixelRatio = 1.0;
    ...
    testWidgets('renders side-by-side Row on medium or wider screens', (
      tester,
    ) async {
  ...
  group('Adaptive Font & Icon Scaling Tests', () {
    testWidgets('returns compact size on phone screen (<600dp)', (
      tester,
    ) async {
    ...
    testWidgets(
      'scales up font and icon sizes on compact-medium tablet/foldable (600-719dp shortest side)',
      (tester) async {
    ...
    testWidgets(
      'scales up font and icon sizes on large tablet (expanded or portrait tablet shortestSide >= 720dp)',
      (tester) async {
          ...
          MaterialApp(
            home: Builder(
              builder: (context) {
                ...
                defaultScaledFont = context.adaptiveFontSize(16);
                explicitLargeFont = context.adaptiveFontSize(
                  16,
                  largeTabletSize: 26,
                );
                autoScaledTabletFont = context.adaptiveFontSize(
                  16,
                  tabletSize: 20,
                );
                defaultScaledIcon = context.adaptiveIconSize(24);
                explicitLargeIcon = context.adaptiveIconSize(
                  24,
                  largeTabletSize: 40,
                );
                autoScaledTabletIcon = context.adaptiveIconSize(
                  24,
                  tabletSize: 30,
                );
                return const SizedBox();
    ...
    testWidgets(
      'identifies portrait tablet (e.g. 834x1194 or 768x1024) as isLargeTablet',
      (tester) async {
