...
class _ResultScreenState extends ConsumerState<ResultScreen> {
  ...
  Future<void> _handleOpenInGallery() async {
    ...
    if (!opened && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Could not open gallery viewer'),
        ),
      );
    }
  }
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // 1. Compact Before/After Comparison Card
              BeforeAfterCard(result: result),
              const SizedBox(height: 10),

              // 2. Compact 2×2 Specs & Metadata Grid
              Container(
                      ...
                      child: Container(
                        ...
                        child: const Center(
                          child: Row(
                            ...
                            children: [
                              Icon(Icons.check_circle_rounded, color: Colors.green, size: 17),
                              SizedBox(width: 5),
                              Text(
                                'Saved ✓',
                                style: TextStyle(
              ...
              // 4. Secondary Action Row (Share & Send to PC)
              Row(
                children: [
                  Expanded(
                    child: SizedBox(
              ...
              // 5. Slim Cyber Cafe & Form Fillers Hint Card
              InkWell(
              ...
              // 6. Tertiary: Process Another Image Button
              Center(
                child: TextButton(
